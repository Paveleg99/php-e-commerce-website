...
<section id="specialPrice" class="">
	<div class="container py-5 ">
		<div class="title_container">
			<h4 id="catTitle" class="font-rubik font-size-20 font-weight-title">Выгодная цена</h4>
			<hr>
		</div>
		<div id="catRow" class="row">
			...
			if ($noResult) {
				...
				<h3><strong>К сожалению, в данной категории товары отсутствуют.</strong></h3>
				<h4>Но мы обязательно добавим их позднее.</h4> 
				</div>
				</div>
				</div>
				</div>';
